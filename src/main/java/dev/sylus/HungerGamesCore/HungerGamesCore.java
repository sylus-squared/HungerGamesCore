...
public final class HungerGamesCore extends JavaPlugin {
    ...
    * CHEST RARITY
    ...
    public void onEnable() {
        ...
        PlayerDeathEvent playerDeathEvent = new PlayerDeathEvent(game, files, gameTimer);
        ...
        getCommand("borderTest").setExecutor(new BorderTest(border, this));
        getCommand("databaseTest").setExecutor(new DatabaseTest(databases));

        // Set the default values for the world border
        ...
        databases.initiliseDatabase("test");
    }
